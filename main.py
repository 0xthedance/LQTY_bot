...
def add_new_trove(new_trove: ContractLog, liquity) -> None:
    ...
    new_trove (ContractLog): Information from the contract log corresponding
    to the newly created trove.
    """
...
def new_trove_details(trove_details: ContractLog, liquity) -> None:
    ...
    Arg: trove_details(ContractLog): Information from the contract log
    corresponding to the updated trove.
    """
